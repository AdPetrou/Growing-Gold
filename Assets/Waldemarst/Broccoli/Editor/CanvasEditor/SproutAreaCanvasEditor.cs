...
namespace Broccoli.TreeNodeEditor
{
	...
	public class SproutAreaCanvasEditor {
		...
		/// </summary>
		private static Color sproutAreaBorderLineColor = Color.red;
		/// <summary>
		/// The color of the sprout area pivot.
		/// </summary>
		private static Color sproutAreaPivotColor = Color.blue;
		/// <summary>
		...
		public void DrawCanvas (Rect area, Texture2D texture, SproutMap.SproutMapArea sproutArea) {
			...
			int border = 10;
			Rect canvas = new Rect (area.x + border, 
				area.y + border, 
				area.width - border - border, 
				area.height - border - border);
			...
			DrawSproutArea (sproutArea);
		}
		/// <summary>
		/// Draws the sprout area for the selection.
		/// </summary>
		/// <param name="sproutArea">Sprout area.</param>
		public void DrawSproutArea (SproutMap.SproutMapArea sproutArea) {
			// Draw bounding box.
